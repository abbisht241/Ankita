...
export const testimonialsData: Testimonial[] = [
  {
    ...
    quote: 'Dr. Ankita Bisht ma’am’s concept-based method completely changed my approach. I struggled with Textile Chemistry and Research Statistics. Her notes, Gold Medalist approach, and live doubt solving helped me jump to 224 marks and secure AIR 09 in Home Science JRF!',
    year: 'Dec 2024 Cycle',
  ...
  },
  {
    ...
    quote: 'The Research Methodology course is pure gold. Ma’am explained parametric vs non-parametric tests, sampling bias, and research proposal drafting so intuitively that my Ph.D. synopsis was approved in one go at university interview!',
    year: '2024 Selection',
