...
export const coursesData: Course[] = [
  {
    ...
    fullDesc: 'Master all 10 units of UGC NET General Paper 1 with Dr. Ankita Bisht. From Research and Teaching Aptitude to Mathematical Reasoning, Data Interpretation, ICT, People & Environment, and Higher Education System. Get bilingual conceptual notes, 2018-2024 solved PYQ breakdowns, and NTA-level CBT mock tests.',
    duration: '4.5 Months (120+ Hours)',
    liveHours: '120+ Live Interactive Hours',
    validity: '1 Year Full Access (Including Recordings)',
    originalPrice: 4999,
    price: 999,
    rating: 4.95,
    reviewsCount: 1420,
    studentCount: '4,850+ Enrolled',
    medium: 'Bilingual (Hindi + English Explanation & Notes)',
    targetExams: ['UGC NET JRF General', 'CSIR NET General', 'SET Exams (MH-SET, WB-SET, AP-SET, K-SET)', 'Ph.D. Entrance PET'],
    highlights: [
      '10 Units 100% Comprehensive Coverage',
      'Daily 1.5-Hour Live Interactive Classes with Chat & Audio Doubt',
      'High-Yield Unit-wise PDF Mindmaps & Formula Sheets',
      '30+ Full Length NTA CBT Mock Tests with Detailed Solutions',
      'Weekly PYQ Analysis (2018 to 2024 Dec Cycle)'
    ],
    keyBenefits: [
      'Achieve 80+ marks in Paper 1 to guarantee your JRF cut-off',
      'Eliminate fear of Data Interpretation & Mathematical Reasoning with shortcut tricks',
      '100% conceptual mastery in Research Methodology & Higher Education',
      'Personal 1-on-1 strategy call with Dr. Ankita Bisht for score optimization'
    ],
    syllabusModules: [
      {
        unitNumber: 'Unit 1',
        unitTitle: 'Teaching Aptitude',
        hours: '14 Hours',
        topics: [
          'Levels of Teaching (Memory, Understanding & Reflective)',
          'Learner Characteristics (Adolescent and Adult learners, Individual differences)',
          'Factors Affecting Teaching (Teacher, Learner, Support material, Environment)',
          'Methods of Teaching (Teacher-centered vs Learner-centered, SWAYAM, MOOCs)',
          'Evaluation Systems (Choice Based Credit System, Computer Based Testing, Innovations)'
        ]
      },
      {
        unitNumber: 'Unit 2',
        unitTitle: 'Research Aptitude & Ethics',
        hours: '16 Hours',
        topics: [
          'Meaning, Types, and Characteristics of Research (Positivism & Post-positivistic)',
          'Methods of Research (Experimental, Descriptive, Historical, Qualitative & Quantitative)',
          'Steps of Research & Hypothesis Formulation',
          'Thesis and Article Writing (Format and Styles of Referencing APA, MLA, Chicago)',
          'Application of ICT in Research & Research Ethics / Plagiarism UGC norms'
        ]
      },
      {
        unitNumber: 'Unit 3 & 4',
        unitTitle: 'Comprehension & Communication',
        hours: '12 Hours',
        topics: [
          'Reading Comprehension speed techniques & Inference-based questions',
          'Communication: Meaning, Types (Verbal, Non-Verbal, Intercultural, Classroom)',
          'Effective Communication Barriers & Mass-Media and Society'
        ]
      },
      {
        unitNumber: 'Unit 5 & 6',
        unitTitle: 'Mathematical Reasoning & Logical Reasoning',
        hours: '22 Hours',
        topics: [
          'Number series, Letter series, Codes and Relationships, Fractions, Time & Distance',
          'Understanding structure of arguments, Categorical propositions, Mood & Figure',
          'Formal and Informal Fallacies, Uses of Language, Connotations & Denotations',
          'Classical Square of Opposition, Venn diagrams, Indian Logic (Pramanas, Hetvabhasa)'
        ]
      },
      {
        unitNumber: 'Unit 7 & 8',
        unitTitle: 'Data Interpretation (DI) & Information & Comm. Tech (ICT)',
        hours: '18 Hours',
        topics: [
          'Quantitative & Qualitative Data, Graphical Representation (Bar, Pie, Table-chart)',
          'DI Calculation Speed Hacks & Percentage/Ratio Shortcuts',
          'ICT: General abbreviations and terminology, Basics of Internet, Intranet, E-mail',
          'Digital initiatives in Higher Education (DigiLocker, ABC ID, Swayam Prabha, NDL)'
        ]
      },
      {
        unitNumber: 'Unit 9 & 10',
        unitTitle: 'People, Development & Environment & Higher Education System',
        hours: '20 Hours',
        topics: [
          'MDGs & SDGs, Environmental Issues (Air, Water, Climate change, Montreal/Kyoto/Paris)',
          'Institutions of Higher Learning and Education in Ancient India (Takshashila, Nalanda)',
          'Evolution of Higher Learning and Research in Post-Independence India',
          'National Education Policy (NEP 2020) in-depth provisions & Regulatory bodies (UGC, NTA, NAAC)'
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    duration: '3.5 Months (80+ Hours)',
    liveHours: '80+ Live Interactive Hours',
    validity: '1 Year Full Access',
    originalPrice: 3999,
    price: 999,
    rating: 4.96,
    reviewsCount: 1650,
    studentCount: '5,200+ Enrolled',
    medium: 'Bilingual (Hindi + English)',
    targetExams: ['CTET Paper 1 & Paper 2 (Target 30/30 CDP)', 'DSSSB PRT/TGT/PGT', 'KVS / NVS Recruitment', 'REET / UPTET / MPTET / HTET', 'Super TET'],
    highlights: [
      'Concept-First Real Classroom Case Studies and Scenarios',
      'Coverage of Piaget, Vygotsky, Kohlberg, Erikson, Freud, Gardner',
      'Exclusive Focus on Inclusive Education, RPWD Act 2016, and NEP 2020 / NCF 2023',
      '1,500+ Practice MCQs with Keyword Elimination Technique',
      'Printable Colored Mindmaps for Fast 10-Minute Revision'
    ],
    keyBenefits: [
      'Consistently score 28+ out of 30 in CTET and State TET CDP sections',
      'Master pedagogical decision-making questions that confuse 90% of students',
      'Understand child psychology from infancy to adolescence with real-life teaching examples',
      'Free access to monthly live doubt-clearing sessions and mock exams'
    ],
    syllabusModules: [
      {
        unitNumber: 'Unit 1',
        unitTitle: 'Concept of Growth, Development & Maturation',
        hours: '14 Hours',
        topics: [
          'Principles of Child Development (Cephalocaudal, Proximodistal, Continuity, Individual Diff)',
          'Influence of Heredity and Environment (Nature vs Nurture debate)',
          'Socialization Processes: Family, Peer Groups, School, and Media',
          'Stages of Development: Infancy, Early Childhood, Late Childhood & Adolescence Challenges'
        ]
      },
      {
        unitNumber: 'Unit 2',
        unitTitle: 'Core Developmental & Learning Theories',
        hours: '22 Hours',
        topics: [
          'Jean Piaget: Stages of Cognitive Development (Schema, Assimilation, Accommodation, Equilibration)',
          'Lev Vygotsky: Socio-Cultural Theory (ZPD, Scaffolding, Private Speech, MKO)',
          'Lawrence Kohlberg: Moral Development Stages & Carol Gilligan’s Critique',
          'Erik Erikson: 8 Stages of Psychosocial Development',
          'Behavioral (Thorndike, Pavlov, Skinner) vs Social Learning (Bandura)'
        ]
      },
      {
        unitNumber: 'Unit 3',
        unitTitle: 'Constructivism, Intelligence & Personality',
        hours: '16 Hours',
        topics: [
          'Theories of Intelligence: Spearman Two-Factor, Thurston Group Factors, Guilford 3D',
          'Howard Gardner: Theory of Multiple Intelligences & Sternberg Triarchic Theory',
          'Assessment of Intelligence (IQ, Mental Age) & Emotional Intelligence (EQ)',
          'Individual Differences among Learners (Linguistic, Religious, Gender, Social Diversity)'
        ]
      },
      {
        unitNumber: 'Unit 4',
        unitTitle: 'Inclusive Education & Children with Special Needs (CWSN)',
        hours: '14 Hours',
        topics: [
          'Addressing Learners from Diverse Backgrounds (Disadvantaged, Deprived, Gifted, Creative)',
          'Learning Disabilities: Dyslexia, Dysgraphia, Dyscalculia, Dyspraxia, ADHD, Autism',
          'Rights of Persons with Disabilities (RPWD Act 2016 - 21 Disabilities)',
          'Inclusive Classroom Strategies, Accommodations & Assistive Technologies'
        ]
      },
      {
        unitNumber: 'Unit 5',
        unitTitle: 'Learning & Pedagogy, Assessment & NEP 2020',
        hours: '14 Hours',
        topics: [
          'How Children Think and Learn; Why Children Fail in School Systems',
          'Assessment OF, FOR, and AS Learning; Formative vs Summative Assessment',
          'Holistic Progress Card (HPC), Continuous & Comprehensive Evaluation (CCE)',
          'National Curriculum Framework (NCF-SE 2023) & NEP 2020 Pedagogical Structure (5+3+3+4)'
        ]
      }
    ]
  },
  {
    ...
    medium: 'Bilingual (Hindi + English)',
    targetExams: ['Dietitian & Nutritionist Exams', 'FSSAI Technical Officer', 'Assistant Professor Exams', 'Community Nutrition Officer'],
    highlights: [
    ...
    keyBenefits: [
      'Master all nutrition & biochemistry calculations for competitive exams',
  ...
  },
  {
    ...
    isPopular: false,
    shortDesc: 'Deep theoretical foundation for B.Ed, M.Ed, UGC NET, Assistant Professor & Lecturer recruitment exams.',
    ...
    medium: 'Bilingual (Hindi & English)',
    targetExams: ['B.Ed & M.Ed University Exams', 'Assistant Professor College Cadre (PSC Exams)', 'PGT Education & Lecturer Exams', 'State SET Exams'],
    highlights: [
    ...
    keyBenefits: [
      ...
      'Score high in Subject Papers in PSC Assistant Professor and Lecturer exams',
